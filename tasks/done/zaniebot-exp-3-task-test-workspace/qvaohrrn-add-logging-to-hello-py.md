...
Add Python logging to hello.py. Set up a logger at module level, log an info message when main() runs, and add a --verbose flag to enable debug logging. Update README.md.
